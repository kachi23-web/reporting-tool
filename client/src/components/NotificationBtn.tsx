...
import chatGroupImage from '@/assets/google-logo.png'
  ...
  return (
    <div>
        ...
        <div className="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <a href="#" className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
            <div className="flex-shrink-0">
                <Image className="rounded-full w-11 h-11" src={chatGroupImage} alt="Joseph image" />
            ...
            <a href="#" className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
            <div className="flex-shrink-0">
                <Image className="rounded-full w-11 h-11" src={chatGroupImage} alt="Bonnie image" />
            ...
            <a href="#" className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
            <div className="flex-shrink-0">
                <Image className="rounded-full w-11 h-11" src={chatGroupImage} alt="Leslie image" />
